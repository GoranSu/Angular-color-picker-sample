...
export class AppComponent {
  ...
  public articles: Article[] = [
    ...
    { title: 'Article Five', subtitle: 'Article Five subtitle', content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. IPraesent libero. Sed cursus ante dapibus diam. Sed nisi.', image: 'https://www.gstatic.com/webp/gallery3/1.png', link: 'www.google.com', active: false, 
    colors: {
        backgroundColor: '#fff',
        fontColor: '#ff0000',
        linkColor: '#4b4fce',
